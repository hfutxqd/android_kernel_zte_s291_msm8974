...
static struct msm_sensor_power_setting imx135_power_setting[] = {
	/* init standby/reset gpio status */
	{
	...
	},
	{
		...
		.seq_val = CAM_VIO,
		.config_val = 0,
		.delay = 0,   /* ZTE_MODIFY   modify power up time 2013-8-13 */
	},
#if 0	
	{
		.seq_type = SENSOR_GPIO,
...
#endif
	{
		...
		.seq_val = SENSOR_GPIO_RESET,
		.config_val = GPIO_OUT_HIGH,
		.delay = 2,   /* ZTE_MODIFY   modify power up time 2013-8-13 */
	},
